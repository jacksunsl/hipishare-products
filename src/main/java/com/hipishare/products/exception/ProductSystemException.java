package com.hipishare.products.exception;
...
public class ProductSystemException extends RuntimeException {
	...
	private static final long serialVersionUID = -1837303184215000174L;

	private static final Logger LOGGER = Logger.getLogger(ProductSystemException.class);
	...
	public ProductSystemException(String code, String message) {
		this.code = code;
		this.msg = message;
	}
	...
	public static void raise(String code) {
		...
		ProductSystemException exception = new ProductSystemException(code, message);
		throw exception;
	}
